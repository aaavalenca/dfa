...
class LevelViewModel : ObservableObject {
    ...
    [
        LevelModel(
            ...
            objective: "I want you to collect as many 👽 as you need. Your finish spot is marked with 🏁, which, incidentally, is also your place of departure.",
            finishX: 0.5,
            finishY: 0.68,
            finishAngle: -15),
        ...
        LevelModel(levelNum: 2,
                   ...
                   angles: [65, -50, -65, -70, -75],
                   objective: "I want you to collect an odd number of 👽. Your finish spot is marked with 🏁.",
                   finishX: 0.34,
                   finishY: 0.24,
                   finishAngle: -67),
        ...
        LevelModel(levelNum: 3,
                   ...
                   yPos: [0.75, 0.75, 0.4, 0.1, -3],
                   angles: [65, -50, -65, -70, -75],
                   objective: "I want you to collect an even number of 👽. Your finish spot is marked with 🏁.",
                   finishX: 0.5,
                   finishY: 0.6,
                   finishAngle: -18),
        ...
        LevelModel(levelNum: 4,
                   ...
                   objective: "In your travels, I want you to, at least once, gather 👽👽 consecutively. Your finish spot is marked with 🏁.",
                   finishX: 0.53,
                   finishY: 0.32,
                   finishAngle: 140)]
}
